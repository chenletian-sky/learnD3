...
import IndexChartData from  '../../assets/json/IndexChartData.json'

const indexChartData = IndexChartData

const d3DrawIndexChart = (data:any) => {
...
onMounted(() => {
  d3DrawIndexChart(indexChartData)
})
</script>
